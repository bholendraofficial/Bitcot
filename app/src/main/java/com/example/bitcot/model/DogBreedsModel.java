package com.example.bitcot.model;
...
public class DogBreedsModel implements Serializable {
    ...
    private List<Object> pyrenees;

    @SerializedName("affenpinscher")
    private List<Object> affenpinscher;

    @SerializedName("kuvasz")
    private List<Object> kuvasz;

    @SerializedName("dingo")
    private List<Object> dingo;

    @SerializedName("pug")
    private List<Object> pug;

    @SerializedName("husky")
    private List<Object> husky;

    @SerializedName("dachshund")
    private List<Object> dachshund;
    ...
    private List<Object> appenzeller;

    @SerializedName("schipperke")
    private List<Object> schipperke;

    @SerializedName("stbernard")
    private List<Object> stbernard;

    @SerializedName("basenji")
    private List<Object> basenji;
